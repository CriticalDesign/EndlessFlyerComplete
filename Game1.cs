...
namespace GME1011EndlessFlyerComplete
{
    public class Game1 : Game
    {
        ...
        //textures we need
        private Texture2D _backgroundTexture, _obstacleTexture, _starTexture, _gameOverTexture;
        ...
        protected override void LoadContent()
        {
            ...
            _destroyer1 = new Destroyer((rng.Next(75,151)/100.0f), 1300f, (float)rng.Next(100,500));
            _destroyer2 = new Destroyer((rng.Next(75,151)/100.0f), 1300f, (float)rng.Next(100,500));
            ...
            _gameOver = new GameOver(_gameOverTexture);
        }
        ...
        protected override void Update(GameTime gameTime)
        {
                                        ...
                                        //when they crash, stop the updates!!
            {
                ...
                _wallBuilder.DestroyStars(_player, _scoreKeeper);
